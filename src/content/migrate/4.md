...
If you are still using Node.js v4 or lower, you need to upgrade your Node.js installation to Node.js v6 or higher as the source was upgraded to a higher ECMAScript version and support for Node.js versions lower than 6 are no longer supported.

You could check [this](https://stackoverflow.com/questions/10075990/upgrading-node-js-to-latest-version) query on StackOverflow on instructions to upgrade your Node.js version.
